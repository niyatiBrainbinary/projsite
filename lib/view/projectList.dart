...
_projectList({required String projectName,required String Id,required String location,required String admin,}){
    return Column(
      ...
      children: [
        ...
        getExpandedRowText(
            sub1: "Project Name", sub2: projectName),
        getExpandedRowText(
            sub1: "Location", sub2: location),
        getExpandedRowText(
            sub1: "Project Admin", sub2: admin),
        Row(
          ...
          children: [
            ...
            getIconWithUnderlineText(
              ...
              underlineColor: HexColor.lavender, text: 'View Sub Project',width: screenWidth(context,dividedBy:2.5), height: screenHeight(context,dividedBy: 40),
              onTap: () {
                Navigation.instance.navigate(AddNew.id);
              },
            ),
                  ...
                  if(state is ProjectListLoading){
                    ...
                    return ListView.builder(
                      ...
                      return  getCommonContainer(
                        ...
                        color: Colors.transparent,
                        child:_projectList(
                            projectName: _projectListCubit.projectsList[index].projectName,Id: _projectListCubit.projectsList[index].id, location: _projectListCubit.projectsList[index].projectLocation, admin: _projectListCubit.organization[index].firstName
                        )
                      );
                    },);
                  }
