                ...
                children: [
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          (RentalCub.rentalList[index].vendorName!.length >= 30)
                              ? SizedBox(
                  ...
                  //     width: 60, color: Colors.transparent, child: Image.network('${ApiRoutes.Image_URL}'+'${RentalCub.rentalList[index].itemImage}',fit: BoxFit.cover,)
                  // ),
                  // Image(image: AssetImage('${ApiRoutes.Image_URL}'+'${RentalCub.rentalList[index].itemImage}'))
                ],
              ),
            ),
            getSimpleRowText(
